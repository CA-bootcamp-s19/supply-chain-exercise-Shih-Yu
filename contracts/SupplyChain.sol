...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  ...
  function buyItem(uint _sku) public payable paidEnough(items[_sku].price) checkValue(items[_sku].sku) forSale(items[_sku].sku) {
  ...
  function shipItem(uint _sku) public verifyCaller(items[_sku].seller) sold(items[_sku].sku) {
  ...
  function receiveItem(uint _sku) public verifyCaller(items[_sku].buyer) shipped(items[_sku].sku)  { 
